...
| BL-2 | Shift & Compliance Configuration | High | Must | Phase 1 | Done | [link](features/02-shift-compliance-configuration.md) | Provides `available_shift_minutes` input to requirement calc. Shipped Sprint 2 (2026-09-09); ERD bumped to v3 (`is_active`/`activated_by`/`activated_at`). |
